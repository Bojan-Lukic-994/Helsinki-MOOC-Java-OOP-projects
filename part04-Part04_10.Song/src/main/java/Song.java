...
Both are set in the public Song(String name, int length) constructor. Also, add to the object the methods public String name(), 
...
public class Song {
    ...
    //method that returns the length of the song (in seconds)
    public int length() {
        return this.length;
    }
}
