...
Implement the interface Comparable in a way, such that the overridden compareTo method sorts the humans according to wage from largest to smallest salary.
*/
