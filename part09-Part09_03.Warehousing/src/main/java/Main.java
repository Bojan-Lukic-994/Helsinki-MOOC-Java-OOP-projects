/*
PART1: The class Warehouse handles the functions related to the amount of a product. 
...
PART2: Let's also add a setter for the product name while we're at it:
...
PART3: The storing of the change history could of course have been done using an ArrayList<Double> object in the class ProductWarehouse.
However, we want our own specialized tool for this purpose. The tool should be implemented by encapsulating the ArrayList<Double> object.
...
PART4: Build on the ChangeHistory class by adding analysis methods:
...
PART5: mplement ProductWarehouseWithHistory as a subclass of ProductWarehouse. 
...
PART6: Expand the class with the following methods
...
PART7: Expand the class with the method
